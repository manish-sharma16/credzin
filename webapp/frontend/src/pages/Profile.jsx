...
//   expenseRange: "5000-15000",
//   CardAdded: [
//     { _id: "card1", last4: "1234", bank: "HDFC" },
//     { _id: "card2", last4: "5678", bank: "ICICI" }
//   ],
...
//     setSaving(true);
//     // Simulate API call. Replace with your PATCH/PUT request.
//     setTimeout(() => {
//       setUser(editUser);
//       setEditMode(false);
//       setSaving(false);
...
//         <ProfileField
//           label="Token"
//           value={user.token ? user.token.slice(0, 20) + "..." : <span className="text-gray-400">N/A</span>}
//         />
//         <div>
//           <span className="font-semibold">Credit Cards Added:</span>
//           {user.CardAdded && user.CardAdded.length > 0 ? (
//             <ul className="list-disc ml-6 mt-1">
//               {user.CardAdded.map((card) => (
//                 <li key={card._id}>
//                   Bank: <span className="font-medium">{card.bank}</span>, Last 4 digits: <span className="font-medium">{card.last4}</span>
//                 </li>
//               ))}
//             </ul>
//           ) : (
